...
//		}
    ...
    {
    	// EditorUi.debug(`sendMessage(\'saveDataToFile\' folder=${folder} filename=${filename}`);
		electron.sendMessage('saveDataToFile', [folder, filename, format, data, mime, base64Encoded]);
    };
